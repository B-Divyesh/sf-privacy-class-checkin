...
export default defineConfig({
  ...
  webServer: { command: 'npm run build && cargo run', url: 'http://127.0.0.1:8080/health', timeout: 120_000, reuseExistingServer: true, env: { DATABASE_URL: 'sqlite://data/e2e.db?mode=rwc', EXPORT_SIGNING_KEY: 'e2e-only-signing-key' } },
